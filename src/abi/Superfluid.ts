export const SuperfluidAbi = [
  {
    inputs: [
      ...
      { internalType: 'uint64', name: 'callbackGasLimit', type: 'uint64' },
      {
      ...
      { internalType: 'address', name: 'simpleAclAddress', type: 'address' },
    ],
  ...
  { inputs: [], name: 'HOST_NO_APP_REGISTRATION_PERMISSION', type: 'error' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'contract SimpleForwarder', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'getSimpleACL',
    outputs: [
      { internalType: 'contract IAccessControl', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
